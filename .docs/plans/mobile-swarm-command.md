...
- [x] **Mobile Responsive UI**: `SwarmObserver` is too dense; needs a "Condensed" mode. [COMPLETED]
- [x] **Command Input**: Text-heavy `/commands` are slow on mobile keyboards; need a "Quick-Action" radial menu or bar. [COMPLETED]
